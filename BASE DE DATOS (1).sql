...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "BENEFICIARIO" AS OBJECT(
...
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "BENEFICIARIO" 
IS
	CONSTRUCTOR FUNCTION beneficiario
		RETURN SELF AS RESULT
	IS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "BENEFICIARIOS" AS ARRAY(10) OF beneficiario ;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "CUENTA" AS OBJECT(
...
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "CUENTA" 
IS
	CONSTRUCTOR FUNCTION cuenta
		RETURN SELF AS RESULT
	IS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "CUENTAS" AS ARRAY(10) OF cuenta ;
...
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "CLIENTE" 
IS
	CONSTRUCTOR FUNCTION cliente
		RETURN SELF AS RESULT
	IS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "TRANSACCION" AS OBJECT(
...
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "TRANSACCION" 
IS
	CONSTRUCTOR FUNCTION transaccion
		RETURN SELF AS RESULT
	IS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "BANCO" AS OBJECT(
	id_banco VARCHAR2(3),
	nombre	VARCHAR2(20),
    saldo	DEC(12,2),
...
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "BANCO" 
IS
	CONSTRUCTOR FUNCTION banco
		RETURN SELF AS RESULT
	IS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "MENSAJE" AS OBJECT(
...
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "MENSAJE" 
IS
	CONSTRUCTOR FUNCTION mensaje
		RETURN SELF AS RESULT
	IS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "REGISTRO" AS OBJECT(
...
/
CREATE OR REPLACE NONEDITIONABLE TYPE BODY "REGISTRO" 
IS
	CONSTRUCTOR FUNCTION registro
		RETURN SELF AS RESULT
	IS
...
--------------------------------------------------------
  ...
  CREATE TABLE "BANCO_TAB" OF "BANCO" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "CLIENTE_TAB" OF "CLIENTE" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" ) 
...
--------------------------------------------------------
  ...
  CREATE TABLE "MENSAJE_TAB" OF "MENSAJE" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "REGISTRO_TAB" OF "REGISTRO" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" ) 
 SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "TRANSACCION_TAB" OF "TRANSACCION" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" ) 
 SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
REM INSERTING into BANCO_TAB
SET DEFINE OFF;
Insert into BANCO_TAB (ID_BANCO,NOMBRE,SALDO) values ('002','BANCO 2','0');
Insert into BANCO_TAB (ID_BANCO,NOMBRE,SALDO) values ('003','BANCO 3','0');
Insert into BANCO_TAB (ID_BANCO,NOMBRE,SALDO) values ('004','BANCO 4','0');
Insert into BANCO_TAB (ID_BANCO,NOMBRE,SALDO) values ('005','BANCO 5','0');
Insert into BANCO_TAB (ID_BANCO,NOMBRE,SALDO) values ('006','BANCO 6','0');
Insert into BANCO_TAB (ID_BANCO,NOMBRE,SALDO) values ('007','BANCO 7','0');
Insert into BANCO_TAB (ID_BANCO,NOMBRE,SALDO) values ('008','BANCO 8','0');
REM INSERTING into CLIENTE_TAB
SET DEFINE OFF;
Insert into CLIENTE_TAB (ID_CLIENTE,NOMBRES,APELLIDOS,FECHA_NACIMIENTO,TIPO_DOCUMENTO,NUMERO_DOCUMENTO,DIRECCION,ESTADO_CLIENTE,LISTA_CUENTAS) values ('00002','JUAN','ACERO',to_date('06/01/00','DD/MM/RR'),'CC','1010082269','transversal 16a','A',CUENTAS(CUENTA('001000002', 'COP', 43400000, 12500000, '2022-03-22 01:33:30.0', 'AHR', BENEFICIARIOS(BENEFICIARIO('00001', 'jose', '001000001', 'CC', '101010', '003')))));
Insert into CLIENTE_TAB (ID_CLIENTE,NOMBRES,APELLIDOS,FECHA_NACIMIENTO,TIPO_DOCUMENTO,NUMERO_DOCUMENTO,DIRECCION,ESTADO_CLIENTE,LISTA_CUENTAS) values ('00001','Daniel','Bermudez Morales',to_date('06/01/00','DD/MM/RR'),'CC','1010082269','transversal 16a','A',CUENTAS(CUENTA('001000001', 'COP', 6650000, 1662500, '2022-03-22 01:34:21.0', 'PRE'BENEFICIARIOS())));
REM INSERTING into MENSAJE_TAB
SET DEFINE OFF;
Insert into MENSAJE_TAB (COD_MENSAJE,DESCRIPCION) values ('0','Transaccion Realizada');
Insert into MENSAJE_TAB (COD_MENSAJE,DESCRIPCION) values ('1','El banco no existe');
Insert into MENSAJE_TAB (COD_MENSAJE,DESCRIPCION) values ('2','La cuenta no existe en el banco beneficiario');
Insert into MENSAJE_TAB (COD_MENSAJE,DESCRIPCION) values ('3','La cuenta receptora se encuentra en otra divisa');
Insert into MENSAJE_TAB (COD_MENSAJE,DESCRIPCION) values ('4','Faltan datos necesarios para efectuar la transacci�n');
Insert into MENSAJE_TAB (COD_MENSAJE,DESCRIPCION) values ('5','Transaccion en proceso');
REM INSERTING into REGISTRO_TAB
SET DEFINE OFF;
REM INSERTING into TRANSACCION_TAB
SET DEFINE OFF;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "ADD_BENEFICIARIO" ( 
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "ADD_CUENTA" ( 
   numero_cuenta VARCHAR2,
   cliente_id  VARCHAR2,
   divisa VARCHAR2,
   saldo DEC)
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "CREDITO" ( cliente_id  VARCHAR2, num_cuenta VARCHAR2, monto DEC)
IS
 cliente_aux  cliente;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "CREDITO_BANCO" ( banco_id  VARCHAR2, monto DEC)
IS
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "DEBITO" (cliente_id  VARCHAR2, num_cuenta VARCHAR2 , monto DEC)
IS
 cliente_aux  cliente;
 lsta_cuenta cuentas := cuentas();
 saldo_aux dec;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "DEBITO_BANCO" ( banco_id  VARCHAR2, monto DEC)
IS
BEGIN
  UPDATE banco_tab set saldo = saldo-monto where id_banco = banco_id ;
END debito_banco;
...
CREATE OR REPLACE NONEDITIONABLE TRIGGER "T_TRANSACCION" 
...
/
ALTER TRIGGER "T_TRANSACCION" ENABLE;
--------------------------------------------------------
--  DDL for Procedure PR_SEND_PAYMENT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "PR_SEND_PAYMENT" (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE FUNCTION "FN_RECEIVE_PAYMENT" (
	p_trace_key VARCHAR2,--(20),
	p_sender_bank VARCHAR2,--(3)
